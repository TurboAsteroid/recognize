...
if __name__ == "__main__":
    ...
    #start = time.time()
    #classifier = train("C:/Projects/WebstormProjects/recognize/public/face_tmp", model_save_path="uemAuto.clf")
    #classifier = loadClf("./python/uemAuto_new.clf")
    classifier = loadClf("./python/uemAuto_dir.clf")
    #end = time.time()
    ...
    for filename in sys.stdin:
        ...
        predictions = predict("./upload/" + filename.rstrip(), knn_clf=classifier, model_path="trained_knn_model.clf")

        # Print results on the console
        #for name, (top, right, bottom, left) in predictions:
        #    print("- Found {} at ({}, {})".format(name, left, top))
        if len(predictions) and len(predictions[0]):
            print(filename.rstrip() + "|||***|||" + predictions[0][0])
        else:
